// backend/controllers/adminController.js — FIXED & EXPORT-READY
...
const deleteUser = async (req, res) => {
  try {
    ...
    await Watchlist.deleteMany({ userId: req.params.id });   // fixed field name if needed
...
// CRITICAL: Proper object export at the bottom
module.exports = {
  getUsers,
  deleteUser,
  toggleAdmin,
